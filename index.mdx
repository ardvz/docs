...
## What is HostGate?
HostGate is a Game Hosting and Generic Hosting service provider platform designed to provide convenience, flexibility, and optimal performance for a wide range of users, from casual Minecraft players, script developers, to large-scale server management teams.
